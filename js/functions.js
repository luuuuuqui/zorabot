...
/**
 * @param {{id: string, jid: string, lid: string, admin: string | null}[]} participants 
 * @returns {string[]}
 */
...
const idlt = '@s.whatsapp.net';

const chyt = '556681147547' + idlt;
const supre = '556681147547' + idlt;

const nit = chyt;
const sesc = supre;

module.exports = { getBuffer, fetchJson, fetchText, generateMessageID, getGroupAdmins, getMembros, getRandom, temporizador, color, recognize, bgcolor, isFiltered, addFilter, chyt, getExtension, convertSticker, upload, nit, getpc, supre, sesc, cfonts }
